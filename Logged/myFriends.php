<?php
    ...
    $query = $connection -> prepare("SELECT user1 as user, username FROM friends, users WHERE user2=? AND pending=0 AND user1=email");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <ul class="navbar-nav ms-3 me-2 my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#" aria-disabled="true">I miei amici</a> 
                        </li>
