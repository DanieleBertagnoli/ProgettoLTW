<?php
    ...
    if(!isset($_GET['errorMessage'])) //Se il messaggio di errore non è stato passato, ne fornisco uno standard
    ...
    { $errorMessage = $_GET['errorMessage']; } //Altrimenti salvo il messaggio passato
...
<html lang="en">
    ...
    <body>
        ...
        <div class="general-container">
            ...
            <!-- Box contente il messaggio di errore -->
